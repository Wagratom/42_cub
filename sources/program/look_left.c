...
/*   Updated: 2023/01/26 13:11:39 by hectfern         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <cub3D.h>

static void	set_cos_and_sin_l(double *ptr_cos, double *ptr_sin, double rotation)
{
...
static void	update_dir_left(t_map *map, double dir[])
{
	...
	old_dir_x = dir[P_X];
	set_cos_and_sin_l(&cos_rotation, &sin_rotation, map->rot_speed);
