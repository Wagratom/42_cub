...
/*   Updated: 2023/01/30 17:28:27 by wwalas-          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
MU_TEST(north)
{
	...
	mu_assert_string_eq(get_path_coordinate("NO ./path_to_the_north_texture\n"), result);

	result = "./e dois real a palma da banana\n";
	mu_assert_string_eq(get_path_coordinate("NO ./e dois real a palma da banana\n"), result);
}
