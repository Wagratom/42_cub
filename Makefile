...
#    Updated: 2023/02/10 13:13:27 by wwalas-          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES		=	verify_extension.c open_file.c valid_map.c valid_chars.c valid_chars_ults.c verify_exit.c	\
				...
				jump_next_square.c look_left.c look_right.c debug.c debug_ready_msgs.c set_direction.c texture.c \
				jump_next_square.c look_left.c look_right.c debug.c debug_ready_msgs.c \
				...
				render_brackground.c mini_map.c
